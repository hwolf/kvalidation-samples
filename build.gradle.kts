...
dependencies {
    ...
    implementation(platform("io.github.hwolf.kvalidation:kvalidation-bom:0.5.7"))
    ...
    testImplementation("org.tinylog:tinylog-impl:2.6.0")
    testImplementation("org.tinylog:slf4j-tinylog:2.6.0")
}
